...
namespace AutomationTool.Helpers
{
    class StartPhotoDownload
    {
        ...
        {
            Percent = LDataContructor.Percent;
            TimeLeft = LDataContructor.TimeLeft;
            DownloadedPhotos = LDataContructor.Downloaded;
            Started = LDataContructor.Time;
            ProcessBar = LDataContructor.Progres;
        ...
        public void DownloadStart()
        {
            ...
            WhatToDo.Downloading = false;

            if(WhatToDo.SearchDubel == true)
            {
                WhichFun SelsectFunction = WhichFun.DoubleSearcer;
                Runner.RunMainThreadFunc(SelsectFunction, DataContructor);
            }
            else if (WhatToDo.CutPhotos == true)
            {

            }
            else if (WhatToDo.ChangeNames == true)
            {
